...
class RoleSeeder extends Seeder
{
  public function run()
  {
    ...
    Permission::create(['name' => 'admin.categores.index'])->syncRoles([$role1, $role2]);
    Permission::create(['name' => 'admin.categores.create'])->syncRoles([$role1, $role2]);
    Permission::create(['name' => 'admin.categores.edit'])->syncRoles([$role1, $role2]);
    Permission::create(['name' => 'admin.categores.destroy'])->syncRoles([$role1, $role2]);
